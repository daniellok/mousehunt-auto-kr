...
(() => {
  ...
  var PUZZLE_FORM_SELECTOR = ".mousehuntPage-puzzle-formContainer";
  var PUZZLE_IMAGE_SELECTOR = ".mousehuntPage-puzzle-form-captcha-image > img";
  var PUZZLE_CODE_INPUT = ".mousehuntPage-puzzle-form-code";
  var PUZZLE_SUBMIT_BUTTON = ".mousehuntPage-puzzle-form-code-button";
  var PUZZLE_RESUME_BUTTON = ".mousehuntPage-puzzle-form-complete-button";
  var PUZZLE_NEW_CODE_LINK = ".mousehuntPage-puzzle-form-newCode a";
  ...
  function getLineColors(img) {
    for (let col = 160; col < 200; col++) {
      ...
      const filtered = colors.filter((pixel, idx) => colors.indexOf(pixel) === idx).map((pixel) => JSON.parse(pixel)).filter((pixel) => !isWhite(pixel));
